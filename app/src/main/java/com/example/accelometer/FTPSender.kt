    ...
    private fun uploadFileToFTP(): Vysledek {
        ...
        try {
            ...
            FileInputStream(localFile).use { inputStream ->
                ...
                chyba = when (kod) {
                    530 -> "Login incorrect: Please check your username and password."
                    ...
                    530 -> "Not logged in: Please log in before performing this operation."
                    ...
                    450 -> "Requested file action not taken: The FTP server could not execute the requested file action."
                    451 -> "Requested action aborted: Local error in processing."
